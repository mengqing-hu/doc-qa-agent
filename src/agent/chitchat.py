...
If the request asks about this conversation itself, answer it using the
conversation history below. Otherwise, answer using your own general
knowledge. Keep the reply concise and conversational. Do not claim the answer
comes from any document, and do not invent citations.
